...
-->
	...
	<div class="well well-small">
		<h1>Check Out <small class="pull-right"> ${TotalQuantyCart} Sản phẩm trong giỏ hàng </small></h1>
	<hr class="soften"/>	
	...
	<table class="table table-bordered table-condensed">
              ...
              <tbody>
	              <c:forEach var="item" items="${Cart }">
	                  ...
	                  <td><input type="number" min="0" max="1000" class="span1" style="max-width:34px" placeholder="1" id="quanty-cart-${item.key }" size="16" type="text" value="${item.value.quanty }"></td>
	                  <td>
