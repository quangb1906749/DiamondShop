					...
					<div class="well">
						...
						<form:form action="dang-ky" method="POST" modelAttribute="user">
							...
							<div class="control-group">
								...
								<div class="controls">
									<form:input class="span3" type="text" placeholder="Họ và tên" path="display_name"/>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="inputAddress">Địa chỉ</label>
								<div class="controls">
									<form:input class="span3" type="text" placeholder="Địa chỉ" path="address"/>
								</div>
							</div>
							<div class="controls">
								<button type="submit" class="btn block register">Đăng ký</button>
							</div>
						</form:form>
					</div>
				</div>
