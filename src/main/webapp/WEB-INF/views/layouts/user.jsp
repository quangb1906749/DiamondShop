		...
		<div class="container">
			<div class="alignR">
				...
				<c:if test="${not empty LoginInfo }">
					...
					<a href="<c:url value="/dang-xuat"/>"><span class="icon-user"></span>Đăng xuất</a>
				</c:if>
				<c:if test="${empty LoginInfo }">
					<a href="<c:url value="/dang-ky"/>"><span class="icon-edit"></span> Đăng ký </a> 
				</c:if>
				<a href="contact.html"><span class="icon-envelope"></span> Contact us</a>
				<a href="<c:url value="gio-hang" />"><span class="icon-shopping-cart"></span> ${TotalQuantyCart } Sản phẩm - <span class="badge badge-warning"> <fmt:formatNumber type="number" groupingUsed="true" value="${TotalPriceCart }"/>₫</span></a>
			</div>
		</div>
	</div>
</div>
